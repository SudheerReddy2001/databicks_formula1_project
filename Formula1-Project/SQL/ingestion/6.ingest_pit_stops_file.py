...
if source_point=="adls":
    final_df.write.format("parquet").mode("overwrite").save(f"{processed_folder}/pit_stops_adls")
elif source_point=="table":
    final_df.write.format("delta").mode("overwrite").saveAsTable("f1_processed.pit_stops")
