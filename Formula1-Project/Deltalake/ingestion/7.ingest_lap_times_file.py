...
if source_point=="adls":
    final_df.write.format("delta").mode("overwrite").save(f"{processed_folder}/lap_times_adls")
elif source_point=="table":
    final_df.write.format("parquet").mode("overwrite").saveAsTable("deltalake_processed.lap_times")
